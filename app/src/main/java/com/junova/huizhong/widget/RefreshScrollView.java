...
public class RefreshScrollView extends ScrollView {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		default:
			...
			if (getScrollY() == 0) {
				if (headerView.getTopMargin() > 0 && enableRefresh
						&& !refreshing) {
					refreshing = true;
	...
	public void resetHeaderView() {
		...
		scroller.startScroll(0, -margin, 0, finalMargin + margin,
				SCROLL_DURATION);
	...
	public void setOnRefreshScrollViewListener(
			OnRefreshScrollViewListener listener) {
