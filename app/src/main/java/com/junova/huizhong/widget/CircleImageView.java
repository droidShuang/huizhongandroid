...
public class CircleImageView extends ImageView{
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CustomImageView_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CustomImageView_color, DEFAULT_BORDER_COLOR);
