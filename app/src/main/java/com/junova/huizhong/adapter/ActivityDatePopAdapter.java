...
public class ActivityDatePopAdapter extends BaseAdapter {
	Context con;
	int year;
	int month;
	List<MyDate> list;
	...
	public ActivityDatePopAdapter(Context con, int year, int month, PopupWindow pop) {
		this.con = con;
		this.year = year;
		this.month = month;
		this.pop = pop;
